...
const exerciseImages: Record<string, any> = {
  'Jogging': { uri: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663305037201/knULhMeIBZZsLXUV.png' },
  ...
  'Volleyball Spike Box Jump': { uri: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663305037201/cOBEuWrKbpAaljoa.png' },
};
