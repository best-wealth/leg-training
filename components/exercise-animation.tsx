...
const joggingImage = { uri: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663305037201/knULhMeIBZZsLXUV.png' };
const boxJumpImage = { uri: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663305037201/cOBEuWrKbpAaljoa.png' };
...
const exerciseImages: Record<string, any> = {
  'Jogging': null, // No image for jogging
  ...
  'Volleyball Spike Box Jump': null, // No image for box jump
};
