...
const exerciseImages: Record<string, any> = {
  'Jogging': { uri: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663305037201/xhSeOxfJpDupIEpB.png' },
  'Hamstring Stretches': { uri: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663305037201/xhSeOxfJpDupIEpB.png' },
  'Calf Stretches': { uri: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663305037201/xhSeOxfJpDupIEpB.png' },
  'Quad Stretches': { uri: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663305037201/xhSeOxfJpDupIEpB.png' },
