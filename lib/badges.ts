...
export const BADGES: Record<BadgeId, Omit<Badge, 'unlockedAt'>> = {
  ...
  leg_curl_50kg: {
    ...
    description: 'Lift 50kg on seated leg curls',
    icon: '🦵',
    category: 'strength',
  },
  leg_curl_75kg: {
    ...
    description: 'Lift 75kg on seated leg curls',
    icon: '🦵',
    category: 'strength',
  },
  leg_curl_100kg: {
    ...
    description: 'Lift 100kg on seated leg curls',
    icon: '🦵',
    category: 'strength',
  },
  ...
  leg_raise_50kg: {
    ...
    description: 'Lift 50kg on seated leg raises',
    icon: '🦵',
    category: 'strength',
  },
  leg_raise_75kg: {
    ...
    description: 'Lift 75kg on seated leg raises',
    icon: '🦵',
    category: 'strength',
  },
  leg_raise_100kg: {
    ...
    description: 'Lift 100kg on seated leg raises',
    icon: '🦵',
    category: 'strength',
  },
  ...
  calf_raise_100kg: {
    ...
    description: 'Lift 100kg on weighted calf raises',
    icon: '🐄',
    category: 'strength',
  },
  calf_raise_150kg: {
    ...
    description: 'Lift 150kg on weighted calf raises',
    icon: '🐄',
    category: 'strength',
  },
  ...
  hip_thrust_100kg: {
    ...
    description: 'Lift 100kg on weighted hip thrusts',
    icon: '🍑',
    category: 'strength',
  },
  hip_thrust_150kg: {
    ...
    description: 'Lift 150kg on weighted hip thrusts',
    icon: '🍑',
    category: 'strength',
  },
  hip_thrust_200kg: {
    ...
    description: 'Lift 200kg on weighted hip thrusts',
    icon: '🍑',
    category: 'strength',
  },
